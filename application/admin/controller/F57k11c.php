 ...
 * @icon fa fa-circle-o
 */
class F57k11c extends Backend
{
    
    /**
     * F57k11c模型对象
     * @var \app\admin\model\F57k11c
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\F57k11c;
        ...
        $this->view->assign("feedbackList", $this->model->getFeedbackList());
    }
