<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"C:\wwwroot\www.qwinfo.com.cn\public/../application/admin\view\f57k12c\add.html";i:1589428732;s:71:"C:\wwwroot\www.qwinfo.com.cn\application\admin\view\layout\default.html";i:1588057008;s:68:"C:\wwwroot\www.qwinfo.com.cn\application\admin\view\common\meta.html";i:1588057008;s:70:"C:\wwwroot\www.qwinfo.com.cn\application\admin\view\common\script.html";i:1588057008;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-UKID" class="form-control" name="row[UKID]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Uk02'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-UK02" class="form-control" name="row[UK02]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Uk03'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-UK03" class="form-control" name="row[UK03]" type="number">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-CLUB" class="form-control" name="row[CLUB]" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[ProcessStatus]-<?php echo $key; ?>"><input id="row[ProcessStatus]-<?php echo $key; ?>" name="row[ProcessStatus]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"已接收"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-ReceiveOn" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[ReceiveOn]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-StartOn" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[StartOn]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Completionon'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-CompletionOn" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[CompletionOn]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
