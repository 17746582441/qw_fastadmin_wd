<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"C:\wwwroot\www.qwinfo.com.cn\public/../application/admin\view\f57k01\edit.html";i:1589428421;s:71:"C:\wwwroot\www.qwinfo.com.cn\application\admin\view\layout\default.html";i:1588057008;s:68:"C:\wwwroot\www.qwinfo.com.cn\application\admin\view\common\meta.html";i:1588057008;s:70:"C:\wwwroot\www.qwinfo.com.cn\application\admin\view\common\script.html";i:1588057008;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Dl01'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-DL01" class="form-control" name="row[DL01]" type="text" value="<?php echo htmlentities($row['DL01']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Pos'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-POS" class="form-control" name="row[POS]" type="text" value="<?php echo htmlentities($row['POS']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-Memo" class="form-control" name="row[Memo]" type="text" value="<?php echo htmlentities($row['Memo']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Efff'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-EFFF" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[EFFF]" type="text" value="<?php echo $row['EFFF']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Efft'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-EFFT" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[EFFT]" type="text" value="<?php echo $row['EFFT']; ?>">
        </div>
    </div>
    <div class="form-group">
